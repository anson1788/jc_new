...
def getDetailsData(element):
    ...
    singelMatch["home"] = remove_html_tags(element[2].get_attribute("innerHTML")).split("[")[0]
    singelMatch["away"] = remove_html_tags(element[4].get_attribute("innerHTML")).split("[")[0]
...
def loadPage():
    loopIdx = 0
    url ='https://zq.titan007.com/cn/SubLeague.aspx?SclassID=30'

...
def monitor_model_available(model_num):
    ...
    if status==503:
        ...
        for i in q1['body']['stores']:
          if i['partsAvailability'][model_num]['messageTypes']['regular']['storeSelectionEnabled']:
            stores[int(i['storeNumber'][1:])]={'storeName':i['storeName'],'city':i['city'],'storeSelectionEnabled':i['partsAvailability'][model_num]['messageTypes']['regular']['storeSelectionEnabled']}
